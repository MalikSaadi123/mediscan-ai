    ...
    <div style={{ background: '#0a0a0f', minHeight: '100vh', display: 'flex', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 60, position: 'relative', borderRight: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
          ...
          <p style={{ color: '#718096', fontSize: 17, lineHeight: 1.7, maxWidth: 340 }}>
            Join thousands of users who understand their health better with AI-powered blood report analysis.
          </p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginTop: 48, textAlign: 'left' }}>
            {[
              ...
              { emoji: '📊', title: 'Detailed Insights', desc: 'Every value explained clearly' },
              { emoji: '⚡', title: 'Lightning Fast', desc: 'Results in under 30 seconds' },
            ].map((item, i) => (
              <motion.div key={i} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}
                ...
                <div>
                  <p style={{ fontWeight: 600, fontSize: 14, marginBottom: 2, color: 'white' }}>{item.title}</p>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 60 }}>
        <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}
          ...
          <h2 style={{ fontSize: 32, fontWeight: 800, marginBottom: 8, color: 'white' }}>Create account</h2>
          <p style={{ color: '#718096', marginBottom: 36, fontSize: 15 }}>Start analyzing your reports for free</p>
          ...
          <div style={{ marginBottom: 18 }}>
            <label style={{ fontSize: 13, color: '#a0aec0', display: 'block', marginBottom: 8, fontWeight: 500 }}>Full Name</label>
            <div style={{ position: 'relative' }}>
              <User size={15} style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', color: '#06b6d4' }} />
              <input type="text" placeholder="Ibrar Saad"
